...
namespace Aibu.InternshipAutomation.Controllers
{
    ...
    public class StudentController : Controller
    {
        ...
        {
            var departmentIdBytes = HttpContext.Session.Get("DepartmentId");

            if (departmentIdBytes == null)
            {
                return RedirectToAction("Login", "Account");
            }

            int departmentId = int.Parse(Encoding.ASCII.GetString(departmentIdBytes));
            ...
            ViewBag.DepartmentName = _departmentDal.DepartmentName(departmentId);
